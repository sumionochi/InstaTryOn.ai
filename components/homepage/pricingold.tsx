  ...
  const plans = [
    {
      ...
      priceIdMonthly: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_BASIC,
      priceIdYearly: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_BASIC,
    ...
    },
    {
      ...
      priceIdYearly: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_PRO,
      popular: true,
    },
    {
      title: "Enterprise",
